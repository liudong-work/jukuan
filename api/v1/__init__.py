...
from .endpoints import auth, trading, strategy, analysis, jq_data, ml_strategy, robo_advisor, strategy_executor, smart_assistant, realtime, monitoring
...
api_router.include_router(monitoring.router, prefix="/monitoring", tags=["实时监控"])
